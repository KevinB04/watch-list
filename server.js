...
app.get("/movies/new", (req, res) => {
    res.send("A from to create a new movie will go here.");
});
...
app.put("/api/movies/:id", (req, res) => {
    res.send (
        "After updating a movie by ID, I will return a response.");
});

app.delete("/api/movies/:id", (req, res) => {
    res.send (
        "After deleting a movie by ID, I will return a response.");
});
